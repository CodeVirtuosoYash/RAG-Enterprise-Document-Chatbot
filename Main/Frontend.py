...
#Cognito Domain
COGNITO_DOMAIN = "https://ap-south-1qywiixzhz.auth.ap-south-1.amazoncognito.com"
CLIENT_ID = "7b7u09615ebcjrsvu07v2v2976"
...
st.subheader("Multi-Organization RAG App", divider="rainbow", anchor=False)
...
def create_s3_folder_structure(organization, department):
    ...
    return f"rag-project-bucket-01/test-output/{org_safe}/{dept_safe}"
            ...
            if uploaded_file and not st.session_state.get("file_uploaded_once", False):
                try:
                    ...
                    payload = {
                        ...
                        "base_output_dir": "rag-project-bucket-01/test-output",
                        "org": organization,
                        "dept": department,
